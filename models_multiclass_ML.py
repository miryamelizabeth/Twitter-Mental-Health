...
if __name__ == '__main__':
	...
	partitionDirNormal = r'Partitions\5FCV_Txt_ESP'
	partitionDirPos = r'Partitions\5FCV_Pos_ESP'
	partitionDirLiwc = r'Partitions\5FCV_Liwc_ESP'
	partitionDirOtros = [r'Partitions\5FCV_All_ESP', r'']

	directoryResults = r'C:\Users\JaneDoe\RESULTS'
	main(partitionDirNormal, partitionDirPos, partitionDirLiwc, partitionDirOtros, directoryResults, language)
